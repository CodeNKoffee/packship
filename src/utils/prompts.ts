...
export function getProjectOptions(languageChoice: string) {
...
export function shouldIncludeFile(choices: any) {
  const {
    includeReadme, useNpmignore, projectType, languageChoice, includeInternalDir, usePostcss, includeLicense, includeCodeOfConduct, useEslint, useWebpack
  } = choices;
